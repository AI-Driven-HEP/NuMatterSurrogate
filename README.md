...
<p align="center">
  <img src="images/image3_1_1.png" width="1000">
</p>
...
If needed, install the PEANUTS dependencies separately when using PEANUTS to generate the simulation data. To initialize it:
...
3. Follow the example notebooks to load the trained model and generate the Earth-matter transition-probability maps for different oscillation parameters.
